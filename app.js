...
//checking all winning possibilites
  if (
    ...
    console.log("winner !"); //if the the possibilities matches
    return true;
  } else if (
    state.c1 !== 0 &&
    state.c2 !== 0 &&
...
const playcase = (e) => {
  ...
  let isVictory= winningpossibility();

  if (isVictory=== true) {
    

    alert("The winner is player " + state.currentplayer);
    ...
    state.matchdraw++;
    noresult.textContent = state.matchdraw;
